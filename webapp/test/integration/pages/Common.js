sap.ui.define([
		...
		function getFrameUrl (sHash, sUrlParameters) {
			var sUrl = jQuery.sap.getResourcePath("projectTwo/projectTwo/app", ".html");
		...
		return Opa5.extend("projectTwo.projectTwo.test.integration.pages.Common", {
			...
			getMockServer : function () {
				return new Promise(function (success) {
					Opa5.getWindow().sap.ui.require(["projectTwo/projectTwo/localService/mockserver"], function (mockserver) {
